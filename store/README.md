...
This directory contains the version-controlled source of truth for Qrive's
Chrome Web Store listing. It is not included in the extension ZIP.

- `listing-en.md` and `listing-ko.md`: localized store copy
...
- `automated-release.md`: GitHub and Chrome Web Store API automation setup
...
file names and links; they contain no account or customer data.
